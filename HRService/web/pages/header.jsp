        ...
        <form method="post" id="loginFrom" action="user!login.action">
            <s:if test="#session.LOGIN_USER==null">
                <div id="topLoginDiv" style="display: inline">
                    <s:text name="username"/>&nbsp;<s:textfield name="user.name"
                                                                id="loginName"
                                                                required="true"
                                                                size="15"/>
                    <s:text name="password"/>&nbsp;<s:password
                        name="user.password" id="loginPassword" required="true"
                        size="15"/>
                    <label class="ui-green">
                        <input type="button" name="loginButton" id="loginButton"
                               value="<s:text name='login'/>"
                               onclick="doLogin();"/>
                    </label>
                    <label class="ui-green">
                        <input type='button' value='<s:text name="register"/>'
                               onclick='document.location="<%=path%>/pages/register.jsp"'/>
                    </label>
                </div>
            </s:if><s:else>
            <s:text name="welcomeTip"><s:param><s:property
                    value="#session.LOGIN_USER.username"/></s:param></s:text>
            &nbsp;&nbsp;&nbsp;
            <label class='ui-green'>
            ...
            <div style="display: inline">
                <label class="ui-green">
                    <input type="button" id="releaseButton" name="search"
                           value="<s:text name='release'/>"/>
                </label>
            </div>
        </form>
    </div>
    ...
    <div>
        ...
        <table>
            <tr>
                <td nowrap="nowrap">
                    <span>&nbsp;&nbsp;&nbsp;用户名：</span>
                    <s:textfield name="user.username" id="uName" required="true"
                                 size="15"/>
                </td>
            </tr>
            <tr>
                <td>
                    <span>&nbsp;&nbsp;&nbsp;密&nbsp;&nbsp;&nbsp;码：</span>
                    <s:password name="user.password" id="uPass" required="true"
                                size="15"/>
                </td>
            </tr>
            <tr>
                <td align="center">
                    &nbsp;&nbsp;&nbsp;
                    <label class="ui-green">
                        <input type="button" name="loginButton" id="divLogin"
                               value="登录"/>
                    </label>&nbsp;
                    <label class="ui-green">
